...
print('Texto cifrado hill es: '+ mensajecodificado)
corrimiento = [chr(ord(a)-3) for a in otro]
mensaje2 = ''.join(corrimiento)
print('Texto en cesar es: {}'.format(mensaje2))
corrimiento2 = [chr(ord(a)-3) for a in mensajecodificado]
print('Texto en otro es: {}'.format(''.join(corrimiento2)))
####################################################################################################
salir=0
while salir==0:
